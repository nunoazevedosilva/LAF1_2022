...
def config ():
    ...
    if cshot=='Yes':
        c_delay=input('Clean Shot Q-Switch Delay = ')

    nshots=input('Number of Shots per spot = ')

    delays = input ('Q-Switch Delay = ')

    coor = input ('Coord =')

    step = input ('Step =' )

    return c_shot, c_delay, n_shots, delays, coor, step
